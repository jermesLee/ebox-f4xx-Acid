...
#define __AT070TN92__
	...
	#define LCD_COMM_ADD		*((vu16 *)0X64000040)//
	#define LCD_DATA_ADD		*((vu16 *)0X64000000)
	
	#define WriteCommand(cmd)	{RA8875_WAITSTATUS();LCD_COMM_ADD = cmd;}//RA8875_WAITSTATUS();
	#define WriteData(data)		{RA8875_WAITSTATUS();LCD_DATA_ADD = data;}
	#define WriteDataHS(data)		{LCD_DATA_ADD = data;}
